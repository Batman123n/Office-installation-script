...
const wchar_t* versions[] = {
    L"Office 2019 Pro Plus ENG",
    L"Office 2021 Pro Plus ENG",
    L"Office 2024 Pro Plus ENG",
    L"Office 365 Enterprise ENG"
};
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE: {
        ...
        hComboBox = CreateWindow(L"COMBOBOX", NULL,
            ...
            cx - 100, 100, 205, 150, hwnd, NULL, NULL, NULL);
...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, int nCmdShow) {
    ...
    HWND hwnd = CreateWindowEx(0, CLASS_NAME, L"Dario installs office",
